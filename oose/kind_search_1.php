...
$kind_serch = $_POST['kind'];

//搜尋資料庫資料
$sql_name = "SELECT * FROM store where kind like binary '%$kind_serch%'";
...
$_SESSION['kind'] = $kind_serch;

?>
<table border="1">

<?php
if (false !== (strpos($row_name[6], $kind_serch))) 
{
    ...
    echo "<form>";
    echo "<input type=\"submit\" formaction=\"search_1.html\" name=\"btn_exit\" value=\"回前頁\" />";
    echo "</form>";
}
else
{
    print("找不到");
    echo '<meta http-equiv=REFRESH CONTENT=2;url=search_1.html>';
}?>
<?php
mysqli_close($link);
?>