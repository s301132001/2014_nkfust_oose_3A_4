...
$level_serch = $_POST['st_level'];

//搜尋資料庫資料
$sql_name = "SELECT * FROM store_comment where st_level like binary '%$level_serch%'";
...
else if (false !== (strpos($row_name[2], $level_serch))) 
{
